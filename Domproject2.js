...
// Number('25')
//  //this will convert the string '25' to number 25


// String(25) 
// //this will convert the number 25 to string 25



// console.log('25'-5)
//   //auto type casting in JavaScript, the string '25' is converted to the number 25 before the subtraction operation is performed, resulting in 20.

// console.log('25'+5)
//  //here it acts differrent because the + operator is used for both addition and string concatenation. In this case, since one of the operands is a string ('25'), JavaScript treats the + operator as a string concatenation operator. Therefore, it converts the number 5 to a string and concatenates it with '25', resulting in the string '255'.
